...
- Location: /__w/Playwright-Typescript-Example/Playwright-Typescript-Example/tests/demo-todo-app.spec.ts:109:2

# Error details

```
TimeoutError: locator.uncheck: Timeout 30000ms exceeded.
Call log:
  - waiting for getByTestId('todo-item').first().getByRole('checkbox')

    at /__w/Playwright-Typescript-Example/Playwright-Typescript-Example/tests/demo-todo-app.spec.ts:119:41
```
