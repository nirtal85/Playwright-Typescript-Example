...
- Location: /__w/Playwright-Typescript-Example/Playwright-Typescript-Example/tests/demo-todo-app.spec.ts:368:3
...
Call log:
  - waiting for getByTestId('todo-item').nth(1).getByRole('checkbox')
    ...
    at /__w/Playwright-Typescript-Example/Playwright-Typescript-Example/tests/demo-todo-app.spec.ts:369:70
```
