...
- Location: /__w/Playwright-Typescript-Example/Playwright-Typescript-Example/tests/demo-todo-app.spec.ts:383:2
...
Call log:
  - waiting for getByTestId('todo-item').nth(1).getByRole('checkbox')
    ...
    at /__w/Playwright-Typescript-Example/Playwright-Typescript-Example/tests/demo-todo-app.spec.ts:385:68
```
